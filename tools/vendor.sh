...
# Regenerates web/vendor.js — the console's bundled
...
#
# Usage: tools/vendor.sh   (requires npm)
 ...
 *
 * Regenerate with tools/vendor.sh — do not edit by hand.
 */
EOF
  cat bundle.js
} > "${out}"
