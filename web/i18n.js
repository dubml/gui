...
const STRINGS = {
  en: {
    ...
    "controlPlane.scope": "Control-plane scope",
    "controlPlane.all": (clusters, healthy, total) =>
      `All · ${clusters} clusters · ${healthy}/${total} healthy`,
    "controlPlane.summary": (clusters, planes) =>
      `${clusters} clusters · ${planes} instances`,
    "controlPlane.unavailable": "instance unavailable",
  ...
  zh: {
    ...
    "controlPlane.scope": "控制平面范围",
    "controlPlane.all": (clusters, healthy, total) =>
      `全部 · ${clusters} 个集群 · ${healthy}/${total} 健康`,
    "controlPlane.summary": (clusters, planes) =>
      `${clusters} 个集群 · ${planes} 个实例`,
    "controlPlane.unavailable": "实例不可用",
...
const langKey = "dubbod-console-lang";
